...
class Imovel(db.Model):   
    ...
    id_endereco = db.Column(db.Integer, ForeignKey('endereco.id_endereco'), nullable=False)
    id_tipo = db.Column(db.Integer, ForeignKey('tipo.id_tipo'), nullable=False)
...
class Proprietario(db.Model):   
    ...
    id_pessoa = db.Column(db.Integer, ForeignKey('pessoa.id_pessoa'))
    id_imovel = db.Column(db.Integer, ForeignKey('imovel.id_imovel'))
    id_gastos = db.Column(db.Integer, ForeignKey('endereco.id_gastos'))
...
class Pagamento(db.Model):   
    ...
    id_banco = db.Column(db.Integer, ForeignKey('banco.id_banco'), nullable=False)
...
class Cliente(db.Model):   
    ...
    id_pessoa = db.Column(db.Integer, ForeignKey('pessoa.id_pessoa'))
    id_endereco = db.Column(db.Integer, ForeignKey('endereco.id_endereco'))
    id_pagamento = db.Column(db.Integer, ForeignKey('pagamento.id_pagamento'))
